package com.elgroup.foodbeat.CustomDialog;
...
public class NewtonCradleLoading extends LinearLayout {
    ...
    private ImageView cradleBallOne;
    private ImageView cradleBallTwo;
    private ImageView cradleBallThree;
    private ImageView cradleBallFour;
    private ImageView cradleBallFive;
    ...
    protected void onFinishInflate() {
        ...
        cradleBallOne = (ImageView) findViewById(R.id.ball_one);
        cradleBallTwo = (ImageView) findViewById(R.id.ball_two);
        cradleBallThree = (ImageView) findViewById(R.id.ball_three);
        cradleBallFour = (ImageView) findViewById(R.id.ball_four);
        cradleBallFive = (ImageView) findViewById(R.id.ball_five);
   ...
   /* public void setLoadingColor(int color) {
    ...
    public ImageView getBall(int pos) {
        switch (pos) {
            case 1:
    ...
    public void setBallsSize(int size){
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(size,size);
        cradleBallOne.setLayoutParams(params);
        cradleBallOne.requestLayout();
        cradleBallTwo.setLayoutParams(params);
        cradleBallTwo.requestLayout();
        cradleBallThree.setLayoutParams(params);
        cradleBallThree.requestLayout();
        cradleBallFour.setLayoutParams(params);
        cradleBallFour.requestLayout();
        cradleBallFive.setLayoutParams(params);
        cradleBallFive.requestLayout();
    }
}
